...
function generateConfig(format, imageProvider, visionProvider, imageKey, visionKey) {
...
async function selectProvider(providers, providerType) {
...
async function main() {
    console.log('\n╔════════════════════════════════════════════════════════════╗');
    console.log('║         Generate Image MCP - Installer                    ║');
    console.log('╚════════════════════════════════════════════════════════════╝\n');
    console.log('This installer will:');
    console.log('  1. Install the generate-image-mcp package');
    console.log('  2. Configure your AI tool (OpenCode, Claude, etc.)');
    console.log('  3. Set up API keys for image generation and vision\n');
