...
import { generateImage } from "./handlers/generate.js";
import { repaintImage } from "./handlers/repaint.js";
...
export async function runServer() {
    ...
    // --- Resources ---
    server.resource("meta", "meta://{path}", async (uri) => {
    ...
    server.resource("history", "history://", async (uri) => {
